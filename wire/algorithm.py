    ...
    "v1": {
        ...
        "source_quality": {
            ...
            2.0: ["Ars Technica", "ProPublica", "MIT Technology Review", "Nature",
                   ...
                   "The Intercept", "New Yorker", "The Independent",
                   "Los Angeles Times", "CBC News", "Axios", "CNBC"],
            1.5: ["TechCrunch", "The Verge", "Fortune", "Forbes",
                   "Fox Business", "Business Insider", "The Hill", "Semafor", "South China Morning Post",
                   "Nikkei Asia", "MacRumors", "CoinDesk", "The Register",
                   "Engadget", "Time", "Slate", "Mother Jones", "New Republic",
                   "The Daily Beast", "Punchbowl News", "STAT News", "The Hollywood Reporter",
                   "Variety", "SemiAnalysis", "The Economic Times", "Rest of World",
                   "9to5Google", "9to5Mac", "Electrek", "CBS News", "ABC News"],
            1.0: ["Android Authority", "Fox News", "USA Today",
                   "MarketWatch", "Yahoo Finance", "Seeking Alpha", "Motley Fool", "Sky News", "Barron's",
                   "ZDNET", "GeekWire", "VentureBeat", "SiliconANGLE",
                   "Tech.eu", "Crunchbase News", "Sherwood News", "Decrypt", "Vox",
                   "Washington Examiner", "Newsweek", "New York Post", "New York Magazine",
                   "HuffPost", "NOTUS", "American Prospect", "The Texas Tribune",
                   "The Philadelphia Inquirer", "Deadline", "NewsNation", "Daily Mail"],
            0.6: ["MSN", "AOL", "Google News", "CTech"],
        },
        ...
        "reputable_sources": [
            ...
            "The Intercept", "New Yorker", "The Independent",
            "Los Angeles Times", "CBC News", "Axios", "CNBC",
            "TechCrunch", "The Verge", "Fortune", "Forbes",
            "Fox Business", "Business Insider", "The Hill", "Semafor", "South China Morning Post",
            "Nikkei Asia", "MacRumors", "CoinDesk", "The Register",
            "Engadget", "Time", "Slate", "Mother Jones", "New Republic",
            "The Daily Beast", "Punchbowl News", "STAT News", "The Hollywood Reporter",
            "Variety", "SemiAnalysis", "The Economic Times", "Rest of World",
            "9to5Google", "9to5Mac", "Electrek", "CBS News", "ABC News",
            "Android Authority", "Fox News", "USA Today",
            "MarketWatch", "Yahoo Finance", "Seeking Alpha", "Motley Fool", "Sky News", "Barron's",
            "ZDNET", "GeekWire", "VentureBeat", "SiliconANGLE",
            "Tech.eu", "Crunchbase News", "Sherwood News", "Decrypt", "Vox",
            "Washington Examiner", "Newsweek", "New York Post", "New York Magazine",
            "HuffPost", "NOTUS", "American Prospect", "The Texas Tribune",
            "The Philadelphia Inquirer", "Deadline", "NewsNation", "Daily Mail",
            "The Information", "TechRadar", "ZDNet",
