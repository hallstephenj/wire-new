...
_TIER_MAP = {
    ...
    # Bitcoin-native specialist press (elevated — primary sources for Bitcoin Wire)
    "Bitcoin Magazine": TIER_4,
    "The Block": TIER_4,
    "Blockworks": TIER_4,
    "Unchained": TIER_4,
    "Decrypt": TIER_4,
    ...
    # Bitcoin community / research publishers
    "River": TIER_5,
    "Swan Bitcoin": TIER_5,
    "Glassnode": TIER_5,
    "10x Research": TIER_5,
    "Bitcoin Optech": TIER_5,
    "Spiral": TIER_5,
    "Blockstream": TIER_5,
    "Lightning Labs": TIER_5,
    "CryptoSlate": TIER_5,
    "Fox News": TIER_5,
    "USA Today": TIER_5,
    "MarketWatch": TIER_5,
